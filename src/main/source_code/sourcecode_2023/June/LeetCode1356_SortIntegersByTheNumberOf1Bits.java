...
public class LeetCode1356_SortIntegersByTheNumberOf1Bits {
    /**
    ...
    class Solution {
        public int count1Bits(String s){
            int res = 0;
        ...
        public int[] sortByBits(int[] arr) {
            ...
            for(Integer i: arr){
                int count = count1Bits(Integer.toBinaryString(i));

                if(tmap.get(count) == null){
                    List<Integer> l = new ArrayList<Integer>();
                    l.add(i);
                    tmap.put(count, l);
                }else{
                    List<Integer> l = tmap.get(count);
                    l.add(i);
                    tmap.put(count, l);
                }
